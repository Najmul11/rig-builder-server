...
const userLogin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelper_1.jwtHelpers.createToken({ _id, userEmail }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    const refreshToken = jwtHelper_1.jwtHelpers.createToken({ _id, userEmail }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    return {
        accessToken,
        refreshToken,
    };
