...
const addProduct = (0, catchAsyncError_1.default)((req, res) =>
...
const getAllProducts = (0, catchAsyncError_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_constant_1.paginationFields,
    );
...
const getSingleProduct = (0, catchAsyncError_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
